...
public class EmployeeRestController {
	...
	// searching employee by firstname
	...
	// sorting employees by firstname in ascending order

	@GetMapping("/employees/sort/FirstName/ASC")
	public List<Employee> sortByFirstNameAsc() {
		return employeeService.sortByFirstNameAsc();
	}

	// sorting employees by firstname in descending order

	@GetMapping("/employees/sort/FirstName/DESC")
